 ...
 * 
 * Now that I'm looking at it though this might be a candidate for redux.
 * I could keep a flag of if the front and back indices are currently looking at a vowel or not, then swap then reset the flags.
 * 
