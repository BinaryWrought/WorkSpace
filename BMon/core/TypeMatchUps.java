...
/**
 * This class contains all elemental type match ups and a means for getting dual type match ups.
 * Its methods and arrays are all static so no instance of this class needs to be kept and maintained.
 * 
...
{   
    ...
    /**
     * Method to get a single type's defense array
     * @param type
     * @return 
     */
    public static Integer[] getSingleType( Elements type )
    {
     ...
     */
    public static Integer[] getDualType( Elements one, Elements two )
    {
     ...
     */
    public static void printAllDualTypes( boolean withInboundAttacks )
    {
